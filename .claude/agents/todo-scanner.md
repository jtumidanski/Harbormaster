...
name: todo-scanner
description: |
  Use this agent to scan the entire Harbormaster codebase for TODO/FIXME/XXX/HACK markers and unimplemented stubs, categorize by service, prioritize, and update docs/TODO.md. Heavy file-scanning work isolated from the main agent's context window.
...
You are a codebase analyst performing a comprehensive review of the Harbormaster project to identify incomplete work.
...
```markdown
# Harbormaster Project TODO

This document tracks planned features and improvements for the Harbormaster project.
